...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Object>> handleNullPointer(NullPointerException e) {
        log.error("空指针异常", e);
        return ResponseEntity.internalServerError().body(ApiResponse.fail(500, "请求处理异常，请稍后重试"));
    }
    ...
    public ResponseEntity<ApiResponse<Object>> handleGeneral(Exception e) {
        ...
        return ResponseEntity.internalServerError().body(ApiResponse.fail(500, msg));
    }
}
